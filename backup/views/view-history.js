...
const RecordView = {
  ...
  renderZodiacButtons: (zodiacPrediction, drawZodiac, hasDrawResult) => {
    ...
    const drawBtnHtml = hasDrawResult ? `<div class="zodiac-btn draw-result ${zodiacPrediction.some(item => item.zodiac === drawZodiac) ? 'hit-blue' : 'miss-red'}">${drawZodiac}</div>` : '';
  ...
  renderSelectedZodiacButtons: (selectedZodiacs, drawZodiac, hasDrawResult) => {
    ...
    const drawBtnHtml = hasDrawResult ? `<div class="zodiac-btn draw-result ${selectedZodiacs.includes(drawZodiac) ? 'hit-blue' : 'miss-red'}">${drawZodiac}</div>` : '';
